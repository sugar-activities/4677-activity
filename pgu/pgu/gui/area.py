...
class SlideBox(container.Container):
    ...
    def __init__(self, widget, width, height, **params):
        ...
        Arguments:
            ...
            width, height -- __size of scrollable area
    ...
    def paint(self, s):
        ...
        pguglobals.app.theme.doPaint(self.surface,self.style.background,pygame.Rect(0,0,self.max_rect.w,self.max_rect.h))
...
class ScrollArea(table.Table):
    ...
    def __init__(self, widget, width=0, height=0, hscrollbar=True, vscrollbar=True,step=24, **params):
        ...
        Arguments:
            widget -- widget to be able to scroll around
            width, height -- __size of scrollable area.  Set either to 0 to default to __size of widget.
...
#             box.style.height = self.style.height - hs.rect.h
        ...
        if self.hscrollbar:
            ...
            hs.__size = hs.style.width * box.style.width / max(1,widget.rect.w)
        else:
            box.offset[0] = 0
        ...
        if self.vscrollbar:
            ...
            vs.__size = vs.style.height * box.style.height / max(1,widget.rect.h)
        else:
            box.offset[1] = 0
    ...
    def x_resize(self, width=None, height=None):
        ...
        if self.hscrollbar:
            if self.widget.rect.w <= self.sbox.rect.w:
                self.hscrollbar.__size = self.hscrollbar.style.width
            else:
                self.hscrollbar.__size = max(20,self.hscrollbar.style.width * self.sbox.rect.w / self.widget.rect.w)
            self._hscrollbar_changed(None)
        if self.widget.rect.h <= self.sbox.rect.h: 
            self.vscrollbar.__size = self.vscrollbar.style.height
        else:
            self.vscrollbar.__size = max(20,self.vscrollbar.style.height * self.sbox.rect.h / self.widget.rect.h)
